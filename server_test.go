...
func Test_requestLogger(t *testing.T) {
	...
	const expectedLogString = `time=2023-10-01T12:34:57.000Z level=INFO msg="Served request" method=GET path=/test client_ip=192.0.2.x
	`
	const expectedStatusCode = http.StatusOK

	// Ch 4. Log Strategies Lv 2. Timestamps
